...
def extract_translation(rec, verbose=False):
    ...
    TRANSLATED = r'([Пп]ер(ев)?[.,]?|[Пп]еревод(ы)?[.]?|[Пп]еревел(а|и)?|(Стихи в|[В]|Авториз(ов)?[.]|[Аа]вторизованны[йе])\s+(пер(ев)?(од(е|ах))?[.]?|перевод[ые]?))[,]?\s+'
    TRANSFORMED = r'Пересказ(ал[аи]?)?|Рассказ(ал[аи]?)|Обр(аб)?([.]|(отка|отал|отала))|Перераб[.]|[Вв] (перераб([.]|отке)|обраб([.]|отке))|Литобработка|В изложении|В сокращении|В пересказе|Переделка|Сокр(ащ)?([.]|(eно|ение))|Составил(а)? и обработал(а)?'
    ...
    LANG = r'\s*([Сс](о)?|е)(\s+яз[.])?\s+(?<lang>(\p{Ll}[\p{Ll}-]+(ого|ск[.]?|[.,])|коми|хинди|манси|телугу|' + LANGLIST + r'))'
    LANG_NARROW = r'([Сс](о)?|е)(\s+яз[.])?\s+(?<lang>(' + LANGLIST + ')[,.]?)\s+'
    RE_TRANS = r'.*?(' + LANG_NARROW + r'.*?(?<translate>' + TRANSLATED + r')|' + r'(?<transform>' + r'(?<translate>' + TRANSLAFORMED + r')|' + TRANSFORMED + ')' + r'(.+?(?<translate>' + TRANSLATED + r'))?' + r'(' + LANG + r')?|' +  r'(?<translate>' + TRANSLATED + r')(' + LANG + r')?' + r'(.+?(?<transform>' + TRANSFORMED + '))?' + ').*'
    re_translated = re.compile(RE_TRANS, re.U)
    try:
        is_translated = re_translated.match(rec['editorial'])
        if verbose and is_translated:
            print('EDITORIAL', rec['editorial'])
            print('TRANS: %s %s', rec['editorial'], is_translated.groupdict())
    except KeyError:
        is_translated = False
    if not is_translated:
        try:
            if rec['subtitle'] is not None:
                is_translated = re_translated.match(rec['subtitle'])
                if verbose and is_translated:
                    print('SUBTITLE', rec['subtitle'])
                    print('TRANS: %s %s', rec['subtitle'], is_translated.groupdict())
        except KeyError:
            is_translated = False
    if is_translated:
...
def extract_title_lang(rec, verbose=True):
    ...
    FOLKLORE = r'(?<stem>\p{Lu}\p{Ll}+(с?к|[.,]))(ие|ая|ий)?(\s+нар([.]|одн(ы[йе]|ая)))?(\s+дет[.])?\s+(сказк[аи]|легенд[аы]|эпос|сага|песни|песенки|баллады|фольклор(а)?)'
    WRITERS = r'.+?\s+(?<stem>\p{Ll}+(ск|[.]))(их)?(\s+дет[.])?\s+(писателей|поэтов)'
    PO_MOTIVAM = r'(?<transformed>[Пп]о\s+мотивам|Из|По)\s+(?<stem>\p{Ll}+[.,]?)(\s+нар[.])?\s+(сказ(ок|аний|ке)|поэзии|песен(ок)?)'
    #POETRY = r'Стихи\s+(?<stem>\p{Ll}+(ск|[.]))(их)?)'
    ...
    if has_title_lang:
        if verbose:
            print('TITLELANG', base, has_title_lang.groupdict())
