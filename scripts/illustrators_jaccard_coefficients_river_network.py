...
def preprocess_data(in_dir, threshold):
    ...
    filtered_coeffs = coeffs[coeffs.jaccard_coeff >= threshold]
...
def visualize(data, nodes_data, title, out_dir):
    dates = ["32-39", "40-45", "46-48", "49-50", "51-52", "53-54", "55-57", "58-60",
             "61-63", "64-66", "67-69", "70-71", "74-75", "76-78", "79-81", "82-84"]
...
def main():
    ...
    filtered_coeffs.to_csv(path_or_buf='filtered_jaccard_coeffs.csv')
